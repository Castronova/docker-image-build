...
#wget https://github.com/dtarb/TauDEM-Test-Data/archive/master.zip
#unzip -f master.zip
#chmod -R 777 TauDEM-Test-Data
...
docker run --rm -v $(pwd)/TauDEM-Test-Data:/tmp -v $(pwd)/prepare-test-env.sh:/tmp/prepare-test-env.sh cuahsi/singleuser \
...
## install bats (move to another script)
